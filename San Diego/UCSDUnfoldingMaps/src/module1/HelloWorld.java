...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		...
		map2 = new UnfoldingMap(this, 420, 50, 350, 500, new Google.GoogleMapProvider());
		map2.zoomAndPanTo(zoomLevel, new Location(38.476353f, -1.322187f));
